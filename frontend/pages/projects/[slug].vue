  ...
  <div class="theme-bg-main min-h-screen">
      ...
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div v-if="project.techStack?.length" class="mb-8">
            <h3 class="neo-label mb-3">Technologies Used</h3>
          ...
          <div v-if="project.content" class="neo-card p-8">
            <h3 class="text-lg font-black theme-text-primary mb-4 uppercase tracking-wide">About This Project</h3>
    ...
    <div v-else class="py-24 text-center max-w-6xl mx-auto px-6">
      <div class="neo-card p-12 max-w-md mx-auto">
        <h2 class="text-2xl font-black theme-text-primary mb-4">Project Not Found</h2>
        <p class="theme-text-secondary mb-8 font-medium">The project you're looking for doesn't exist.</p>
        <NuxtLink to="/projects" class="neo-btn-primary font-black">Back to Projects</NuxtLink>
      </div>
    </div>
  </div>
</template>
