<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div v-else-if="project" class="section">
      <NuxtLink to="/projects" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-8">
      ...
      <div class="max-w-4xl mx-auto">
        <!-- Cover Image -->
        <div v-if="project.coverImage" class="aspect-video rounded-2xl overflow-hidden bg-gray-200 mb-8 shadow-lg">
        ...
        <div v-if="project.techStack?.length" class="mb-8">
          <h3 class="text-sm font-medium text-gray-500 mb-3">Technologies Used</h3>
        ...
        <div v-if="project.content" class="card p-8">
          <h3 class="text-lg font-semibold text-gray-900 mb-4">About This Project</h3>
          <div class="prose prose-gray max-w-none whitespace-pre-wrap text-gray-700 leading-relaxed">
            {{ project.content }}
          </div>
        </div>
      </div>
    ...
    <div v-else class="section text-center py-24">
