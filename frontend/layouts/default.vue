        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-3">
          <div class="flex items-center gap-2">
            ...
            <span 
              ...
              :style="{ color: 'var(--pss-footer-content-text, color-mix(in srgb, var(--color-on-footer) 75%, transparent 25%))' }"
            >
              — Building With Neo-Brutalism Style
            </span>
          </div>
          <div class="flex items-center gap-3">
            <a 
